        ...
        <div class="row justify-content-center">
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('shops.parts.store', $shop->id) }}" method="POST" class="form form-vertical" enctype="multipart/form-data">
                        @csrf
                        <div class="form-body">
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        <label for="part">Select Spare Part</label>
                                        <select name="part_id" id="part" class="form-control">
                                            <option selected disabled>Select Spare Part</option>
