    ...
    <div class="row justify-content-center">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('supplier.shops.profile.store', $shop->id) }}" method="POST" class="form form-vertical" enctype="multipart/form-data">
                        @csrf
                        <div class="form-body">
                            <div class="row">
                                <div class="col-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="Sup_name" id="" value="{{ $Supplier->name ?? '' }}">
                                        <input type="hidden" name="suplier_id" value="{{ $Supplier->id ?? '' }}">
                                    </div>
                                    <div class="mb-3">
                                        <label for="" class="form-label">Business Name</label>
                                        <input type="text" class="form-control" name="Businees_name" id="" value="{{ $shop->name ?? '' }}">
                                    </div>
                                ...
                                <div class="col-12">
                                    <div class="mb-3">
                                        ...
                                        @if (isset($profile) && $profile->profile_image)
                                            <img src="{{ asset('storage/' . $profile->profile_image) }}" alt="Profile Image" style="max-width: 200px; display: block; margin-bottom: 10px; border-radius: 50%;">
                                        @endif
                                        <input type="file" class="form-control" name="profile_image" id="">
                                        <small class="text-muted">Square images work best. Max 2MB</small>
                                    </div>
                                    @error('profile_image')
                                        <div class="alert alert-danger mt-2">
                                            {{ $message }}
