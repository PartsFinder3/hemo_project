                        ...
                        <tbody>
                            @foreach ($models as $model)
                                <tr>
                                    ...
                                    <td>{{ $model->year_end ? $model->year_end : 'Continue' }}</td>
                                    <td>
                                        <a href="{{ route('varient.store', $model->id) }}" class="btn btn-sm btn-info">+
                                            Add</a>
                                        <a href="{{ route('varient.show', $model->id) }}" class="btn btn-sm btn-success">↗
                                            Show</a>
                                    </td>
                                    <td>
                                        <a class="btn btn-info" href="{{ route('model.edit', $model->id) }}"><i
