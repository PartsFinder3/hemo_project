                ...
                <div class="row g-0 h-100">
                    ...
                    <div class="col-lg-6">
                        <div class="abdul-signup-right">
                            ...
                            <form action="<?php echo e(route('supplier.create')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="abdul-form-select" name="country_code">
                                        ...
                                        <?php echo $__env->make('Frontend.contries', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    </select>
                                </div>
                            ...
                            <div class="abdul-login-link">
                                Already have an account? <a href="<?php echo e(route('supplier.login')); ?>">Login here</a>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('Frontend.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\partsfinder\resources\views/Frontend/signup.blade.php ENDPATH**/ ?>