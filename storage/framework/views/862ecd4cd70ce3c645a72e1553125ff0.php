                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-2 col-sm-3 col-4 text-center">
                                <div class="supplier-image-wrapper mb-2">
                                    <?php if($p && $p->profile_image): ?>
                                        <img src="<?php echo e(asset('storage/' . $p->profile_image)); ?>" alt="Shop Logo"
                            ...
                            <div class="col-md-3 col-sm-3 col-12 text-md-end mt-3 mt-md-0">
                                <div class="d-flex d-md-block flex-wrap gap-2">
                                    <a href="<?php echo e(route('view.shop', $shop->id)); ?>" class="btn btn-sm btn-orange w-100 my-1">
                                    ...
                                    <a href="tel:<?php echo e($contact); ?>" class="btn btn-sm btn-warning w-100 my-1">
...
<?php echo $__env->make('Frontend.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\partsfinder\resources\views/Frontend/shops/view.blade.php ENDPATH**/ ?>