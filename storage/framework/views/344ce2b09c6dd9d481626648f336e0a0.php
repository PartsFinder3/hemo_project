...
<head>
    ...
    <title><?php echo e($domain->name); ?> - Supplier Dashboard</title>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/compiled/css/flatpickr.css')); ?>">
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-white sticky-top py-2 shadow-sm">
        <div class="container">
            <a class="navbar-brand d-flex align-items-center" style="max-width: 100px" href="#">
                <img style="width: 50%; height: 100%" src="<?php echo e(asset('storage/' . $domain->logo)); ?>" alt="Logo">
            </a>
                ...
                <div class="navbar-nav ms-auto d-flex align-items-center w-100 justify-content-end">
                    ...
                    <div class="nav-item me-4">
                        <span class="badge bg-warning text-dark px-3 py-2 fs-6">
                            ...
                            <?php echo e($daysLeft === 0 ? 'Last day' : $daysLeft . ' days left'); ?>

                        </span>
                    </div>

                    <div class="nav-item me-4">
                        <a href="<?php echo e(route('supplier.panel')); ?>" class="nav-link text-dark fw-semibold px-3 py-2">
                    ...
                    <div class="nav-item me-4">
                        <a href="<?php echo e(route('supplier.courier.services')); ?>"
                            class="nav-link text-dark fw-semibold px-3 py-2">
                    ...
                    <?php if($has_shop): ?>
                        <div class="nav-item me-4">
                            <a class="nav-link text-dark fw-semibold px-3 py-2"
                                href="<?php echo e(route('supplier.shop.profile', $shop_id)); ?>">
                    ...
                    <div class="nav-item dropdown me-3">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end shadow">
                            <li>
                                <a href="<?php echo e(route('supplier.buyer.invoices.index')); ?>" class="dropdown-item py-2">
                            ...
                            <li>
                                <a class="dropdown-item py-2"
                                    href="<?php echo e(route('supplier.password.update', $user->id)); ?>">
                    ...
                    <div class="nav-item">
                        <form action="<?php echo e(route('supplier.logout')); ?>" method="post" class="d-inline">
                            <?php echo csrf_field(); ?>
                            <button type="submit"
    ...
    <nav class="navbar navbar-light bg-white border-top fixed-bottom d-lg-none shadow-sm">
        <div class="container d-flex justify-content-around py-2">
            <a href="<?php echo e(route('supplier.panel')); ?>"
                class="nav-link text-center <?php echo e(request()->routeIs('supplier.panel') ? 'bottom-nav-active' : ''); ?>">
                <i class="fas fa-inbox d-block fs-5"></i>
                <small>Enquiries</small>
            </a>

            <a href="<?php echo e($has_shop ? route('supplier.ads.index', $shop_id) : '#'); ?>"
                class="nav-link text-center <?php echo e(request()->routeIs('supplier.ads.index') ? 'bottom-nav-active' : ''); ?> <?php echo e(!$has_shop ? 'disabled text-muted' : ''); ?>">
                <i class="fas fa-bullhorn d-block fs-5"></i>
                <small>My Ads</small>
            </a>

            <?php if($has_shop): ?>
                <a href="<?php echo e(route('supplier.shop.profile', $shop_id)); ?>"
                    class="nav-link text-center <?php echo e(request()->routeIs('supplier.shop.profile') ? 'bottom-nav-active' : ''); ?>">
                    <i class="fas fa-store d-block fs-5"></i>
                    <small>Shop</small>
                </a>
            <?php endif; ?>

            <a href="<?php echo e(route('supplier.buyer.invoices.index')); ?>"
                class="nav-link text-center <?php echo e(request()->routeIs('supplier.buyer.invoices.index') ? 'bottom-nav-active' : ''); ?>">
                <i class="fas fa-file-invoice d-block fs-5"></i>
                <small>Invoices</small>
            </a>

            <a href="<?php echo e(route('supplier.password.update', $user->id)); ?>"
                class="nav-link text-center <?php echo e(request()->routeIs('supplier.password.update') ? 'bottom-nav-active' : ''); ?>">
                <i class="fas fa-cog d-block fs-5"></i>
                <small>Settings</small>
            </a>
            <a href="<?php echo e(route('supplier.courier.services')); ?>"
                class="nav-link text-center <?php echo e(request()->routeIs('supplier.courier.services') ? 'bottom-nav-active' : ''); ?>">
                <i class="fa-solid fa-truck d-block fs-5"></i>
                <small>Courier</small>
            </a>
        </div>
    </nav>
<?php /**PATH C:\laragon\www\partsfinder\resources\views/supplierPanel/layout/head.blade.php ENDPATH**/ ?>