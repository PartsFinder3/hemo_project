    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="text-center mb-4 border-bottom" style="padding-bottom:15px;">
                <img src="<?php echo e(public_path('assets/compiled/jpg/Logo.png')); ?>" alt="Company Logo" style="max-width: 150px; margin-bottom:10px;">
                <div>
            ...
            <div class="mb-4">
                <div style="float:left; width:60%;">
                    <h3 style="color:#0d6efd; margin:0;">Invoice #: <?php echo e($invoice->invoice_number); ?></h3>
                    <p class="mb-0">Date: <?php echo e($invoice->payment_date); ?></p>
                </div>
            ...
            <div class="mb-4">
                <div style="width:48%; float:left;" class="bg-light rounded p-3">
                    ...
                    <p class="mb-1"><strong>Name:</strong> <?php echo e($invoice->supplier->name ?? ''); ?></p>
                    <p class="mb-0"><strong>Contact:</strong> <?php echo e($invoice->supplier->whatsapp ?? ''); ?></p>
                </div>
                <div style="width:48%; float:right;" class="bg-light rounded p-3">
                    <h4 class="fw-bold mb-2" style="color:#0d6efd;">Payment Info</h4>
                    <p class="mb-1"><strong>Method:</strong> <?php echo e($invoice->payment_method); ?></p>
                    <p class="mb-0"><strong>Date:</strong> <?php echo e($invoice->payment_date); ?></p>
                </div>
                <div style="clear:both;"></div>
            </div>
            ...
            <div class="mb-4">
                ...
                <table>
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $invoice->subscriptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td><?php echo e($sub->type); ?></td>
                                <td class="text-center"><?php echo e($sub->start_date); ?></td>
                                <td class="text-center"><?php echo e($sub->end_date); ?></td>
                                <td class="text-end"><?php echo e(number_format($sub->amount, 2)); ?></td>
                            </tr>
            ...
            <div class="bg-light rounded p-3 mb-3">
                ...
                <div style="float:right; width:30%; text-align:right;">
                    <h4 class="fw-bold mb-0" style="color:#0d6efd;"><?php echo e(number_format($invoice->total_amount, 2)); ?></h4>
                </div>
                <div style="clear:both;"></div>
            </div>
            ...
            <div class="bg-light rounded p-3">
                ...
                <p class="mb-0"><?php echo e($invoice->remarks ?? 'No additional remarks'); ?></p>
            </div>
...
<?php /**PATH C:\laragon\www\partsfinder\resources\views/adminPanel/invoice/pdf.blade.php ENDPATH**/ ?>