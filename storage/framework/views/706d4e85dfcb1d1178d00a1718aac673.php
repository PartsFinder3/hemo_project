...
<head>
    ...
    <?php if(empty($meta) && isset($domain->metaTags)): ?>
    ...
    <!-- Open Graph Meta -->
    <meta property="og:title" content="<?php echo e($domain->metaTags->title); ?>">
    <meta property="og:description" content="<?php echo e($domain->metaTags->description); ?>">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('Frontend/css/style.css')); ?>" media="print" onload="this.media='all'">
