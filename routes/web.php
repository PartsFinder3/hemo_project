...
// <----------------------------- Admin Auth ----------------------------->
    ...
    Route::get('/images/resiz/post', [FrontendController::class, 'images_resiz_post'])->name('imagesresiz.post');
...
Route::get('/create_seo_city/{id}', [FrontendController::class, 'create_seo__city'])->name('city.seo.city');
